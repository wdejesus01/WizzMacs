...
#+RESULTS:
| citar-capf-setup | #[0 \301\211\207 [imenu-create-index-function org-imenu-get-tree] 2] | #[nil ((org-bullets-mode t)) nil] | #[nil ((add-hook 'after-save-hook #'efs/org-babel-tangle-config)) nil] | org-tempo-setup | flyspell-mode | org-latex-preview--clear-preamble-cache | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-fold-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes |
** Org-Roam
#+begin_src emacs-lisp
